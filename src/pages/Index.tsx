    ...
    <MainLayout>
      ...
      <section className="relative">
        ...
        <div className="relative container mx-auto px-4 py-24 text-center">
          ...
          <div className="max-w-xl mx-auto relative mb-8">
            ...
            />
            <Button 
              className="absolute right-1 top-1 bottom-1 bg-legal-accent hover:bg-legal-accent/90"
              onClick={handleSearchClick}
            >
      ...
      <section className="py-16 bg-legal-primary text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <svg className="h-12 w-12 mx-auto mb-6 text-legal-accent" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 text-legal-primary">Ready to Transform Your Legal Research?</h2>
